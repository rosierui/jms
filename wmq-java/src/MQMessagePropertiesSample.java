...
public class MQMessagePropertiesSample {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p800-004-151022.DE su=_8QwZKXivEeWg74sVC8pxOw pn=MQJavaSamples/wmqjava/MQMessagePropertiesSample.java"; //$NON-NLS-1$
  ...
  public void useBasicProperties() throws MQException, IOException {
    ...
    Enumeration<String> propertyNames = messageForGet.getPropertyNames("testB%");
